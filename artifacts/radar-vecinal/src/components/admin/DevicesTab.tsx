                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 mt-2.5 flex-wrap">
                    <button onClick={() => copyLink(d)}
                      className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-white/10 text-[11px] text-white/80 hover:bg-white/10 transition-colors">
                    ...
                    <button onClick={() => toggle(d)} disabled={busyId === d.id}
                      className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-white/[0.05] border border-white/10 text-[11px] text-white/80 hover:bg-white/10 transition-colors disabled:opacity-50">
                    ...
                    <button onClick={() => remove(d)} disabled={busyId === d.id}
                      className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-red-500/10 border border-red-500/30 text-[11px] text-red-300 hover:bg-red-500/20 transition-colors disabled:opacity-50 ml-auto">
