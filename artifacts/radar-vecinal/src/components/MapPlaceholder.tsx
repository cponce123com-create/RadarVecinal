...
const DEMO: Omit<Report, "updatedAt">[] = [
  { id: "d1", title: "Robo en bodega",        category: "robbery"           as any, urgency: "critical" as any, status: "active"   as any, isAnonymous: false, latitude: -11.130, longitude: -75.357, address: "Jr. Junín 245",        sector: "San Ramón Centro", authorName: "Carlos Q.", confirmedCount: 8,  imageUrl: null, description: "", createdAt: new Date(Date.now() - 30*60000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d2", title: "Actitud sospechosa",    category: "suspicious"        as any, urgency: "medium"   as any, status: "reviewing" as any, isAnonymous: true,  latitude: -11.120, longitude: -75.350, address: "Plaza de Armas",       sector: "San Ramón Centro", authorName: "Anónimo",   confirmedCount: 4,  imageUrl: null, description: "", createdAt: new Date(Date.now() - 2*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d3", title: "Pelea callejera",       category: "fight"             as any, urgency: "high"     as any, status: "resolved"  as any, isAnonymous: false, latitude: -11.110, longitude: -75.362, address: "Jr. Progreso 456",     sector: "La Merced",        authorName: "María G.",  confirmedCount: 12, imageUrl: null, description: "", createdAt: new Date(Date.now() - 5*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d4", title: "Corte de agua",         category: "water_cut"         as any, urgency: "medium"   as any, status: "active"   as any, isAnonymous: false, latitude: -11.140, longitude: -75.340, address: "Calle Los Álamos",     sector: "Pampa del Carmen", authorName: "Luis M.",   confirmedCount: 15, imageUrl: null, description: "", createdAt: new Date(Date.now() - 6*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d5", title: "Basura acumulada",      category: "garbage"           as any, urgency: "low"      as any, status: "active"   as any, isAnonymous: false, latitude: -11.148, longitude: -75.375, address: "Av. Circunvalación",   sector: "Los Ángeles",      authorName: "Ana T.",    confirmedCount: 7,  imageUrl: null, description: "", createdAt: new Date(Date.now() - 16*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d6", title: "Emergencia médica",     category: "medical_emergency" as any, urgency: "critical" as any, status: "resolved" as any, isAnonymous: false, latitude: -11.125, longitude: -75.348, address: "Av. Chanchamayo 890",  sector: "San Ramón Centro", authorName: "Luis M.",   confirmedCount: 3,  imageUrl: null, description: "", createdAt: new Date(Date.now() - 18*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d7", title: "Asalto en grifo",       category: "robbery"           as any, urgency: "critical" as any, status: "active"   as any, isAnonymous: false, latitude: -11.135, longitude: -75.355, address: "Jr. Tarma 567",        sector: "San Ramón Centro", authorName: "Carlos Q.", confirmedCount: 20, imageUrl: null, description: "", createdAt: new Date(Date.now() - 7*3600000).toISOString(), district: "San Ramón", districtId: 1 },
  { id: "d8", title: "Incendio en vivienda",  category: "fire"              as any, urgency: "critical" as any, status: "resolved" as any, isAnonymous: false, latitude: -11.115, longitude: -75.370, address: "Jr. Huánuco 123",      sector: "San Luis",         authorName: "Ana T.",    confirmedCount: 18, imageUrl: null, description: "", createdAt: new Date(Date.now() - 20*3600000).toISOString(), district: "San Ramón", districtId: 1 },
];
