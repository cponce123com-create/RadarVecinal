...
export const GetReportsResponse = zod.object({
  ...
  "category": zod.enum(['robbery', 'fight', 'suspicious', 'water_cut', 'garbage', 'informal_commerce', 'noise', 'missing_person', 'fire', 'medical_emergency', 'prostitution', 'drug_point', 'bar_trouble', 'other', 'lost_pet', 'power_outage', 'street_damage', 'stray_dogs', 'flooding']),
...
export const GetPanicAlertsResponse = zod.object({
  ...
  "id": zod.string(),
  "type": zod.enum(['robbery', 'medical', 'fight', 'fire', 'missing_person', 'other']),
  "latitude": zod.number(),
  "longitude": zod.number(),
  "address": zod.string().optional(),
  "authorName": zod.string(),
...
export const CreatePanicAlertResponse = zod.object({
  "id": zod.string(),
  "type": zod.enum(['robbery', 'medical', 'fight', 'fire', 'missing_person', 'other']),
  "latitude": zod.number(),
  "longitude": zod.number(),
...
export const StreamPanicAlertsResponse = zod.unknown()
...
export const CreateMissingPersonResponse = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "age": zod.number().nullish(),
  "clothing": zod.string(),
...
export const GetStatsResponse = zod.object({
  ...
  "topSectors": zod.array(zod.object({
  "sector": zod.string(),
  "count": zod.number()
}))
})
...
export const CreateAdSlotResponse = zod.object({
  "id": zod.string(),
  "businessName": zod.string(),
  "tagline": zod.string(),
  "imageUrl": zod.string().nullish(),
...
export const SeedDataBody = zod.object({
  "districtSlug": zod.string().describe('Slug del distrito a sembrar (ej. \"san-ramon\")')
})
