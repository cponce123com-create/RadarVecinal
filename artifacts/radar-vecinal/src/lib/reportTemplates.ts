...
export const REPORT_TEMPLATES: ReportTemplate[] = [
  ...
  // ── FASE 3: Nuevas categorías ──────────────────────────────────────────────
  {
    ...
    category: ReportCategory.lost_pet,
    urgency: ReportUrgency.high,
    title: "Mascota perdida en la zona",
    description: "Se perdió mi mascota en [dirección/referencia]. Nombre: [nombre]. Especie: [perro/gato/otro]. Color: [color]. Señas particulares: [cicatriz/mancha/collar]. Responde al nombre de [nombre]. Adjunto foto. Contacto: [teléfono].",
  },
  {
    id: "corte_luz",
    emoji: "⚡",
    ...
    urgency: ReportUrgency.high,
    title: "Corte de fluido eléctrico en el sector",
    description: "No hay energía eléctrica desde [hora/fecha]. Afecta aproximadamente [número] cuadras a la redonda en el sector [nombre del sector]. Se solicita restablecimiento urgente.",
  },
  {
    id: "pista_daniada_v2",
    emoji: "🕳️",
    label: "Pista/vereda dañada",
    category: ReportCategory.street_damage,
    urgency: ReportUrgency.medium,
    title: "Pista o vereda en mal estado",
    description: "Hay un [bache/grieta/vereda rota/socavón] en [calle/referencia]. Mide aproximadamente [tamaño] y representa peligro para [vehículos/peatones/ambos]. Está así desde [fecha]. Se solicita reparación municipal.",
  },
  {
    id: "perros_agresivos",
    emoji: "🐕",
    label: "Perros callejeros agresivos",
    category: ReportCategory.stray_dogs,
    urgency: ReportUrgency.high,
    title: "Jauría de perros agresivos en la vía pública",
    description: "Un grupo de aproximadamente [número] perros callejeros se congrega en [referencia/calle]. Han mostrado comportamiento agresivo [mencionar incidentes]. Peligro para niños y transeúntes, especialmente en [horario]. Se solicita intervención de control canino municipal.",
  },
  {
    id: "inundacion",
    emoji: "🌊",
    label: "Inundación/huaico",
    category: ReportCategory.flooding,
    urgency: ReportUrgency.critical,
    title: "Inundación o huaico en la zona",
    description: "Se ha producido [inundación/huaico/desborde] en [calle/referencia] debido a [lluvias intensas/desborde de río/obturación de desagüe]. El agua alcanza aproximadamente [altura] y afecta a [número] viviendas. Se solicita evacuación y ayuda municipal urgente.",
  },
];
